...
def ucto_tokenize(sentence):
    ...
    #if int(ucto_tokenize.counter) % 100 == 0:
    #    print(int(ucto_tokenize.counter))
...
class Encoder:
    ...
    def __init__(self, vocab_size=30522, pct_bpe=1, word_tokenizer=None,
        ...
        self.word_tokenizer = word_tokenizer if word_tokenizer is not None else ucto_tokenize#WhitespaceTokenizer().tokenize#ucto_tokenize#WhitespaceTokenizer().tokenize#ucto_tokenize#WhitespaceTokenizer().tokenize#ucto_tokenize #ucto_tokenize # WhitespaceTokenizer().tokenize #wordpunct_tokenize
        self.word_tokenizer_fitting = ucto_tokenize#WhitespaceTokenizer().tokenize #ucto_tokenize#WhitespaceTokenizer().tokenize#ucto_tokenize#ucto_tokenize#WhitespaceTokenizer().tokenize #WhitespaceTokenizer().tokenize #wordpunct_tokenize
    ...
    def byte_pair_counts(self, words):
        ...
        for token, count in self._progress_bar(self.count_tokens(words).items()):
            ...
            Onegrams = token.split(' ')

            bp_counts[Onegrams[0]] += count
            for i in range(1,len(Onegrams)):
                    bp_counts["##" + Onegrams[i]] += count
            token = "___" + token
    ...
    def subword_tokenize(self, word):
        ...
        while start_idx < len(word):
            ...
            elif len(subword) == 3 and subword[0:2] == "##":
                #print("ye5")
        ...
        if already_has_special_tokens:
            for id in token_ids_0:
                if id == (self.word_vocab[self.PAD] or self.bpe_vocab[self.SOW] or self.bpe_vocab[self.EOW] or
                          self.word_vocab[self.cls_token] or self.word_vocab[self.sep_token]):
